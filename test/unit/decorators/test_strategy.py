...
"""Tests for strategy design pattern tools."""

from unittest.mock import Mock

from pytest import mark, raises

from pr_toolbox.decorators.strategy import (
    _BaseStrategy,
...
class TestBaseStrategyNonParametric:
    """Test BaseStrategy class without parametrization."""

    def test_eq_facade(self):
        """Test equality for strategy facades.

        Note: reflexivity assumed from `TestBaseStrategy.test_eq`, symmetry
        always checked, and transitivity checked where relevant (specified
        in comments).
    ...
    def test_validate_init_signature(self, init, error):
        """Test init method signature validation."""
        if error:
