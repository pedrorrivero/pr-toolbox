...
class classconstant:  # pylint: disable=invalid-name
    ...
    Note: returning constant values by reference is more performant but opens the
    up the possibility to mutating them. For this reason, if the value type is
    not immutable, setting `copy` to `True` is recommended.
    """
